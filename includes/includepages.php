...
function multi_form_step1($image){//step-1 
                ...
                <fieldset id="artist-all">
                   <!-- <img class="arrow-back" src="arrow-back.png" width="40px" height="40px">-->
                    ...
                    <div class="field">
                        ...
                        <input id="sstep1" type=hidden name='step1'>
                    </div>
...
function multi_form_step3(){  //multi step form 3
    $image=plugins_url('../images/arrow-back.png', __FILE__ );
?>
...
function multi_form_step4(){   //multi step form 4
    $image= plugins_url('../images/arrow-back.png', __FILE__ );
?>
